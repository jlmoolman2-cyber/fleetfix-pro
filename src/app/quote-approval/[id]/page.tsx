...
export default function QuoteApprovalPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function approve() {
    ...
    try {
      ...
      console.error(error);
      setMessage("The quote could not be approved. Please contact JobTorq.");
