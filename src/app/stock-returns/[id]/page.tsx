...
export default function DerequisitionSlipPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const historyRows = [
    { id: "created", action: "Created", details: `Parts derequisition ${slip.derequisitionNumber || ""} created`, userName: slip.requestedByName || "JobTorq User", createdAt: slip.requestedAt || slip.createdAt },
    ...slipHistory,
