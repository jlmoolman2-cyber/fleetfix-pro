...
const sections = [
  ...
  {
    title: "Status Notes",
    description: "Manage notes linked to job statuses",
    href: "/admin/instructions",
    icon: "📎",
  },
  {
    title: "Job Card Manager",
    description: "Configure printed and emailed job cards",
    href: "/admin/jobcardmanager",
    icon: "🗂️",
  },
  {
...
].filter((section) => section.href !== "/admin/jobcardfields");
