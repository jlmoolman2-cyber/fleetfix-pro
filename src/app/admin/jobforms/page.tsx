    ...
    async function duplicateForm(
        ...
        try {
            ...
            if (!sourceSnapshot.exists()) {
                throw new Error("The source form no longer exists.");
            }
            ...
            const duplicateRef =
...

                {
                    ...
                    name:
                        `${source.name || form.name} Copy`,

                    category:
                        source.category || form.category || "",

                    active:
                        source.active ?? form.active ?? true,

                    linkType:
                        source.linkType || form.linkType || "Job Card",

                    ...(source.autoAttachToJob !== undefined
                        ? { autoAttachToJob: source.autoAttachToJob }
                        : {}),

                    linkedJobTypes:
                        source.linkedJobTypes || [],
            ...
            router.push(
                `/admin/jobforms/${duplicateRef.id}`
            );
