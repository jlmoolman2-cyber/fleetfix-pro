...
type Capabilities = { view: boolean; manage: boolean; assign: boolean; close: boolean; diagnostics: boolean; manualOutbound: boolean; automationOutbound: boolean; templateOutbound: boolean };
...
export default function WhatsAppInboxPage() {
  ...
  const [capabilities, setCapabilities] = useState<Capabilities>({ view: false, manage: false, assign: false, close: false, diagnostics: false, manualOutbound: false, automationOutbound: false, templateOutbound: false });
