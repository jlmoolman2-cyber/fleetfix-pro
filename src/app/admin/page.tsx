...
const sections = [
  ...
  {
    title: "Company Rates",
    description: "Client labour, travel-time and kilometre rates",
    href: "/admin/companyrates",
    icon: "R/h",
  },
  {
  ...
  },
  {
    ...
    description: "Set up required job photos by job type",
    href: "/admin/photoalbums",
    icon: "📸",
  },
  {
  ...
  },
  {
    ...
    description: "General purchase order settings & purchase order numbering",
    href: "/admin/purchaseordersettings",
    icon: "🛒",
  },
  {
    title: "Supplier Setup",
    description: "Manage supplier numbering settings",
  ...
  },
  {
    ...
    description: "Customize 80 mm requisition and derequisition slips",
    href: "/admin/requisition-slip",
    icon: "SLIP",
  },
  {
    title: "Reports",
  ...
  {
    title: "Vehicle Makes & Models",
    description: "Manage vehicle make, model and type categories",
    href: "/admin/vehiclemakes",
    icon: "🚚",
  },
];
